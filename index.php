...
<body class="bg-gray-100 text-gray-900">
    <div class="flex justify-center items-center h-[100vh]">
        <?php if (isset($_GET['url']) && $_GET['url'] == 'tambah-buku-tamu') : ?>
            <div class="block">
                <a href="./index.php" class="py-1.5 px-2 rounded-md bg-white">
                    < Kembali</a>
                        ...
                        <form class="text-center" action="./src/controllers/BukuTamuController.php?action=add" method="post">
                            ...
                            <button type="submit" class="mt-6 py-1.5 px-3 rounded-md text-white bg-sky-500 hover:bg-sky-600">Tambah</button>
                        </form>
            </div>
        <?php else : ?>
            <form class="bg-white p-12 border border-gray-200 rounded-lg w-min text-center" action="./src/controllers/LoginController.php" method="post">
                ...
                <button class="bg-sky-500 hover:bg-sky-600 px-3 py-1 mb-4 rounded-md duration-300 text-white" type="submit">Login</button> <br />
                <a href="index.php?url=tambah-buku-tamu" class="text-xs text-blue-600 hover:text-blue-800 duration-300">Masuk sebagai tamu</a>
            </form>
        <?php endif ?>
    </div>
</body>
